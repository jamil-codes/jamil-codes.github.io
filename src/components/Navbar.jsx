    ...
    <nav className="bg-base-100 border-b border-base-300 shadow-sm sticky top-0 z-50 backdrop-blur-md">
      <div className="max-w-6xl mx-auto px-4 flex justify-between items-center py-4">
        ...
        <div className="hidden md:flex items-center space-x-4">
          <a href="https://github.com/jamil-codes" target="_blank" className="text-base-content/80 hover:text-base-content transition-colors">GitHub</a>
          <a href="https://linkedin.com/in/jamilcodes" target="_blank" className="text-base-content/80 hover:text-base-content transition-colors">LinkedIn</a>

          {/* Theme Toggle */}
          <button onClick={toggleTheme} className="ml-2 swap swap-rotate">
            {/* Sun */}
            <svg className={`w-5 h-5 ${theme === "light" ? "swap-on" : "hidden"}`} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            {/* Moon */}
            <svg className={`w-5 h-5 ${theme === "dark" ? "swap-off" : "hidden"}`} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      {isOpen && (
        <div className="md:hidden bg-base-100 border-t border-base-300 shadow-lg">
          <div className="flex flex-col items-center py-4 space-y-4">
            <a href="https://github.com/jamil-codes" target="_blank">GitHub</a>
            <a href="https://linkedin.com/in/jamilcodes" target="_blank">LinkedIn</a>

            {/* Mobile Theme Toggle - uses same state */}
